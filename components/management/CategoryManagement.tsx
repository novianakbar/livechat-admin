...
import { RadixButton, RadixInput, RadixTextarea, RadixSelect, RadixCheckbox } from '@/components/ui/radix-form';
        ...
        <div className="p-6">
            ...
            >
                <form onSubmit={handleSubmit}>
                    <RadixModalBody className="space-y-6 max-h-[70vh] overflow-y-auto">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <RadixInput
                                ...
                                helperText={`${Math.floor(formData.sla_first_response / 60)}h ${formData.sla_first_response % 60}m`}
                            />

                            <RadixInput
                                label="Resolution SLA (minutes)"
                                type="number"
                                min="1"
                                value={formData.sla_resolution}
                                onChange={(e) => setFormData({ ...formData, sla_resolution: parseInt(e.target.value) })}
                                helperText={`${Math.floor(formData.sla_resolution / 60)}h ${formData.sla_resolution % 60}m`}
                            />
                        </div>
